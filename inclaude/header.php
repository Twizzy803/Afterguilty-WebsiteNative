...
<body>
    <nav class="navbar bg-light shadow bg-body rounded" style="position: fixed;z-index: 9999;width: 100%;">
        <div class="container-fluid">
            ...
            <div class="nav-item">
                <a href="keranjang.php" style="color: #222222;margin-right: 10px;text-decoration: none;"><i class="ri-shopping-cart-fill" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Keranjang"></i></a>
            </div>
            <div class="nav-item">
                <a href="riwayat.php" style="color: #222222;text-decoration: none;"><i class="ri-history-line" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Riwayat"></i></a>
            </div>
