...
<head>
    ...
    <div class="menu no-gutters">
            ...
            <div class="col-md-10 p-5 pt-3" style="margin-left: 18%;">
                ...
                <hr>
                <?php
                $ambil = $connection->query("SELECT * FROM users_login INNER JOIN users ON users_login.id_users=users.id_users
                INNER JOIN 'profile' ON users_login.id_users=profile.id_users");
                ?>
