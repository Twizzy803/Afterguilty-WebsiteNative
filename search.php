        ...
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5" style="border-radius: 7px;">
            ...
            <div class="col-lg-6">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                    <a type="button" class="btn btn-primary btn-lg px-4 me-md-2" style="background-color: #222222;">Produk</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
            <div class="col-10 col-sm-8 col-lg-6">
                ...
                <form action="" method="GET">
                    ...
                    <button class="btn btn-outline-white" name="search" type="submit" style="background-color: #222222;">Search</button>
                </form>
            </div>
            <div class="col-lg-6">
